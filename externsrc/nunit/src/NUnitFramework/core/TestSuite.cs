...
//		private bool isSetUp;
        ...
        // This overload has been restored for the sole purpose of allowing 
        // the construction of legacy Suites. A new approach will be found
        // for the next release. Don't call this from within NUnit.
        public void Add(object fixture)
        {
            Add(TestFixtureBuilder.Make(fixture));
        }

        public void Add(Type fixtureType)
        {
            Add(TestFixtureBuilder.Make(fixtureType));
        }
		#endregion
