...
namespace NUnit.Util
{
	...
	public class XmlResultVisitor : ResultVisitor
	{
		...
		public void Visit(TestSuiteResult suiteResult) 
		{
			...
			// Non-null message means we had a TestFixtureSetUp or TestFixtureTearDown failure
			// Otherwise, failure is due to lower-level tests having failed.
			if(suiteResult.IsFailure && suiteResult.Message != null)
			{
				xmlWriter.WriteStartElement("failure");
