...
namespace syncroniserFusion.localhost1 {
    ...
    public partial class Service : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Service() {
            this.Url = global::syncroniserFusion.Properties.Settings.Default.syncroniserFusion_localhost_Service;
        ...
        /// <remarks/>
        public void GetFeedAsync(string user, string password) {
            this.GetFeedAsync(user, password, null);
        }
        
        /// <remarks/>
        public void GetFeedAsync(string user, string password, object userState) {
            ...
            this.InvokeAsync("GetFeed", new object[] {
                        user,
                        password}, this.GetFeedOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void NewUserAsync(string user, string password, string opml) {
            this.NewUserAsync(user, password, opml, null);
        }
        
        /// <remarks/>
        public void NewUserAsync(string user, string password, string opml, object userState) {
            ...
            this.InvokeAsync("NewUser", new object[] {
                        user,
                        password,
                        opml}, this.NewUserOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/UpdateFeed", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        public void UpdateFeedAsync(string user, string password, string opml) {
            this.UpdateFeedAsync(user, password, opml, null);
        }
        
        /// <remarks/>
        public void UpdateFeedAsync(string user, string password, string opml, object userState) {
            ...
            this.InvokeAsync("UpdateFeed", new object[] {
                        user,
                        password,
                        opml}, this.UpdateFeedOperationCompleted, userState);
        }
