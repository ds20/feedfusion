...
namespace NewsGatorSyscPlugin.SubscriptionService {
    ...
    public partial class SubscriptionWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public SubscriptionWebService() {
            this.Url = global::NewsGatorSyscPlugin.Properties.Settings.Default.NewsGatorSyscPlugin_SubscriptionService_SubscriptionWebService;
        ...
        public int AddSubscription(string xmlUrl, int folderId, NGOSCredential cred, string customTitle, bool markRead) {
        ...
        /// <remarks/>
        public void AddSubscriptionAsync(string xmlUrl, int folderId, NGOSCredential cred, string customTitle, bool markRead) {
            this.AddSubscriptionAsync(xmlUrl, folderId, cred, customTitle, markRead, null);
        }
        
        /// <remarks/>
        public void AddSubscriptionAsync(string xmlUrl, int folderId, NGOSCredential cred, string customTitle, bool markRead, object userState) {
            ...
            this.InvokeAsync("AddSubscription", new object[] {
                        ...
                        cred,
                        customTitle,
                        markRead}, this.AddSubscriptionOperationCompleted, userState);
        }
        ...
        public ResultType[] DeleteSubscriptions(int[] subscriptionList) {
            object[] results = this.Invoke("DeleteSubscriptions", new object[] {
                        subscriptionList});
        ...
        private void OnDeleteSubscriptionsOperationCompleted(object arg) {
            if ((this.DeleteSubscriptionsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.DeleteSubscriptionsCompleted(this, new DeleteSubscriptionsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        public System.Xml.XmlElement MergeSubscriptions(string locationName, System.Xml.XmlElement opmlDocument, bool markRead) {
        ...
        /// <remarks/>
        public void MergeSubscriptionsAsync(string locationName, System.Xml.XmlElement opmlDocument, bool markRead) {
            this.MergeSubscriptionsAsync(locationName, opmlDocument, markRead, null);
        }
        
        /// <remarks/>
        public void MergeSubscriptionsAsync(string locationName, System.Xml.XmlElement opmlDocument, bool markRead, object userState) {
            ...
            this.InvokeAsync("MergeSubscriptions", new object[] {
                        locationName,
                        opmlDocument,
                        markRead}, this.MergeSubscriptionsOperationCompleted, userState);
        }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://services.newsgator.com/ngws/Result")]
    ...
    public partial class NGOSCredential {
        ...
        [System.Xml.Serialization.XmlElementAttribute("useNGOSCredentials", typeof(bool))]
        public object Item {
            get {
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.42")]
    public delegate void DeleteSubscriptionsCompletedEventHandler(object sender, DeleteSubscriptionsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.42")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class DeleteSubscriptionsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal DeleteSubscriptionsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
